  ...
  return (
    ...
    >
      <head>
        ...
        {/* Microsoft Clarity Official Tracking Script */}
        {trackingSettings?.clarity_enabled !== 'false' && (
          <Script
            ...
            dangerouslySetInnerHTML={{
              __html: `
                ...
                })(window, document, "clarity", "script", "${trackingSettings?.clarity_project_id || 'ymogx7tv3i'}");
              `,
            }}
          />
        )}
