...
const MEGA_MENUS: Record<string, MegaMenuConfig> = {
  ...
  community: {
    col1Title: "COMMUNITIES & NETWORKS",
    col1Links: [
      { label: "TNCC Platform", href: "https://tamilnaducreatorsclub.com/", external: true },
      { label: "THADAM Network", href: "https://thadam.net/", external: true },
      { label: "WhatsApp Community", href: EXTERNAL_URLS.community, external: true },
      { label: "View Full Ecosystem", href: "/community" },
    ],
    col2Title: "ECOSYSTEM",
    col2Links: [
      { label: "Creative Peer Learning", href: "https://tamilnaducreatorsclub.com/", external: true },
      { label: "Verified Directory & Trust", href: "https://thadam.net/", external: true },
      { label: "Client Referrals & Leads", href: "https://thadam.net/", external: true },
      { label: "Community Workshops", href: "https://tamilnaducreatorsclub.com/", external: true },
    ],
    overview: {
      title: "OVERVIEW",
      description:
        "Collaborate with 40,000+ creators in TNCC and expand your business within THADAM's trusted professional network.",
      link: "/community",
      linkLabel: "Explore Both Platforms",
      image: "/assets/community/tncc-logo.jpg",
      imageCaption: "TNCC & THADAM Ecosystem",
    },
  },
  contact: {
